(function() {
    ...
    Demo.mixed = function() {
		...
		var tablet_t = Bodies.circle( 35 * Common.random(1, 14), -(1 * 40), 20, { frictionAir:0.06, render: { sprite: { texture: './img/tablet-01.png' }  } } );
		var tablet_o = Bodies.circle( 35 * Common.random(1, 14), -(2 * 80), 20, { frictionAir:0.06, render: { sprite: { texture: './img/tablet-02.png' }  } } );
		var tablet_l = Bodies.circle( 35 * Common.random(1, 14), -(3 * 80), 20, { frictionAir:0.06, render: { sprite: { texture: './img/tablet-03.png' }  } } );
		var tablet_a = Bodies.circle( 35 * Common.random(1, 14), -(4 * 80), 20, { frictionAir:0.06, render: { sprite: { texture: './img/tablet-04.png' }  } } );
		var tablet_n = Bodies.circle( 35 * Common.random(1, 14), -(5 * 80), 20, { frictionAir:0.06, render: { sprite: { texture: './img/tablet-05.png' }  } } );
		var tablet_z = Bodies.circle( 35 * Common.random(1, 14), -(6 * 80), 20, { frictionAir:0.06, render: { sprite: { texture: './img/tablet-06.png' }  } } );
		var tablet_x = Bodies.circle( 35 * Common.random(1, 14), -(7 * 80), 20, { frictionAir:0.06, render: { sprite: { texture: './img/tablet-07.png' }  } } );
		var tablet_y = Bodies.circle( 35 * Common.random(1, 14), -(8 * 80), 20, { frictionAir:0.06, render: { sprite: { texture: './img/tablet-08.png' }  } } );
		var tablet_w = Bodies.circle( 35 * Common.random(1, 14), -(9 * 80), 20, { frictionAir:0.06, render: { sprite: { texture: './img/tablet-09.png' }  } } );
		...
		var bottle = Bodies.rectangle(-64, 540, 34, 60, { isStatic:true, chamfer: { radius:3 }, render: {fillStyle:'blue', sprite: { texture: './img/bottle.png' } } } );	
		...
		renderOptions.background = './img/tolanz.png';
